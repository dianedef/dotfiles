...
- **Master TASKS.md** (has a "Backlog" section): !`cat /home/claude/TASKS.md 2>/dev/null || echo "No master TASKS.md"`
...
- **Always update the master `/home/claude/TASKS.md` Backlog section** — even when working in a sub-project directory
