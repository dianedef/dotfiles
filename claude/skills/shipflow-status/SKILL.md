...
- PROJECTS.md: !`cat /home/claude/ShipFlow/PROJECTS.md 2>/dev/null | head -20`

## Flow

### Step 1: Read project registry

Read `/home/claude/ShipFlow/PROJECTS.md` to get the list of all projects with their paths. Also include ShipFlow itself (`/home/claude/ShipFlow`).
