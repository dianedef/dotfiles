...
**Domain applicability**: Not all audits apply to all projects. Global mode reads `~/ShipFlow/PROJECTS.md` and skips inapplicable domains (e.g., no SEO for `my-robots`, no Deps for `BuildFlowz`).
