...
1. Read `/home/claude/ShipFlow/PROJECTS.md` — check the **Domain Applicability** table. Identify projects with ✓ in the Code column.
...
5. Update `/home/claude/AUDIT_LOG.md` (one row per project, Code column) and `/home/claude/TASKS.md` (each project's `### Audit: Code` subsection).
