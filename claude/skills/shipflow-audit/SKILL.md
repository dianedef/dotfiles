...
Read `/home/claude/ShipFlow/PROJECTS.md`. Use the **Domain Applicability** table to determine which domains apply to each project.
...
1. **Global `/home/claude/AUDIT_LOG.md`** — one row per project with all domain scores.
2. **Master `/home/claude/TASKS.md`** — update each project's audit subsections.
