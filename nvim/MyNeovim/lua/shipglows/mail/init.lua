...
local function register_which_key()
  ...
  which_key.add({
    ...
    { "<leader>mm", desc = "ouvrir l'email plein écran" },
...
function M.setup(opts)
  require("shipglows.mail.config").setup(opts)
  require("shipglows.mail.reader").setup()
  require("shipglows.mail.review").setup()
  register_which_key()
end
