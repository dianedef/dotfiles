...
local private_data_root = vim.env.SHIPGLOWS_PRIVATE_DATA_DIR
  or vim.fn.expand("~/.shipglows/private/data")
...
M.options = {
  ...
  private_root = vim.env.SHIPGLOWS_MAIL_INTAKE_ROOT or vim.fn.expand("~/.shipglows/private/data/mail-intake"),
  ...
  project_index_root = vim.env.SHIPGLOWS_PROJECT_INDEX_ROOT
