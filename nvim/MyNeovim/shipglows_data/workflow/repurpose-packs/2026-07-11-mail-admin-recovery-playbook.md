...
linked_systems:
  ...
  - "/home/claude/dotfiles/nvim/MyNeovim/shipglows_data/workflow/specs/gmail-filter-management-for-mail-intel.md"
...
- The local registry path resolves to `~/.shipglows/private/data/mail-admin/registry.json`.
...
- Add one account entry in `~/.shipglows/private/data/mail-admin/registry.json`.
