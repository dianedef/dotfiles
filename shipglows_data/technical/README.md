...
evidence:
  ...
  - "/home/claude/dotfiles/shipglows_data/technical/operator-guides/avante-codex-acp.md"
depends_on:
  - "/home/claude/dotfiles/README.md"
  - "/home/claude/dotfiles/CLAUDE.md"
  - "/home/claude/dotfiles/shipglows_data/technical/context.md"
  - "/home/claude/dotfiles/shipglows_data/technical/context-function-tree.md"
  - "/home/claude/dotfiles/shipglows_data/technical/code-docs-map.md"
linked_systems:
  - Bash
  - Neovim
  - Starship
...
- Outils Node globaux via `pnpm`:
  ...
  - Le binaire Codex CLI, ses skills et les configs runtime `~/.claude` / `~/.codex` sont installés par ShipGlows via PNPM. Dotfiles installe uniquement la configuration tmux et son helper, qui utilisent ce binaire.
