...
export SHIPGLOWS_PRIVATE_DIR="${SHIPGLOWS_PRIVATE_DIR:-${SHIPGLOWZ_PRIVATE_DIR:-$HOME/.shipglows/private}}"
export SHIPGLOWS_PRIVATE_DATA_DIR="${SHIPGLOWS_PRIVATE_DATA_DIR:-${SHIPGLOWZ_PRIVATE_DATA_DIR:-$SHIPGLOWS_PRIVATE_DIR/data}}"
# Deprecated compatibility aliases for older local configuration.
export SHIPGLOWZ_PRIVATE_DIR="$SHIPGLOWS_PRIVATE_DIR"
export SHIPGLOWZ_PRIVATE_DATA_DIR="$SHIPGLOWS_PRIVATE_DATA_DIR"
...
export SHIPGLOWS_PRIVATE_DATA_REPO="${SHIPGLOWS_PRIVATE_DATA_REPO:-${SHIPGLOWZ_PRIVATE_DATA_REPO:-${GITHUB_USERNAME:-dianedef}/shipglowz-private-data.git}}"
export SHIPGLOWZ_PRIVATE_DATA_REPO="$SHIPGLOWS_PRIVATE_DATA_REPO"
...
export DOTFILES_PNPM_PACKAGES="${DOTFILES_PNPM_PACKAGES:-${DOTFILES_NPM_PACKAGES:-@openai/codex @apify/mcpc $DOTFILES_CODEX_ACP_PACKAGE tldr eslint}}"
