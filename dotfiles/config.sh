...
export SHIPGLOWS_PRIVATE_DIR="${SHIPGLOWS_PRIVATE_DIR:-$HOME/.shipglows/private}"
...
export SHIPGLOWS_PRIVATE_DATA_REPO="${SHIPGLOWS_PRIVATE_DATA_REPO:-${GITHUB_USERNAME:-dianedef}/shipglows-private-data.git}"
