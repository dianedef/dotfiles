...
# ============================================================================
export DOTFILES_ALL_COMPONENTS="neovim,fzf,gum,nerd-fonts,node,npm-tools,starship,zoxide,yazi,ranger,doppler,gh,lsd,bat,claude-code,claude-chill,copilot,kilocode,opencode,gemini,crush,vercel,mcp,configs,shell-integration"
