...
echo "  re"
echo ""
echo "Profil installé"
echo "  • Neovim Markdown avec config MyNeovimTermux"
echo "  • Plugins Neovim légers: snacks, vim-pencil, surround, gitsigns, markdown"
echo "  • Navigation fichiers: ranger, ripgrep, fd, fzf"
echo "  • Shell: Starship, Zoxide, aliases Termux"
echo "  • Connexion: OpenSSH, autossh, Mosh, tmux"
echo "  • Apparence: JetBrainsMono Nerd Font, termux-theme"
if [ "$SHIPFLOW_LOCAL_INSTALLED" = true ]; then
    echo "  • ShipFlow local tunnels: urls, tunnel"
fi
echo ""
echo "Commandes utiles"
echo "  n          Ouvrir Neovim"
echo "  r          Ouvrir Ranger"
echo "  thermux    Ouvrir le sélecteur de thème"
echo "  urls       Ouvrir les tunnels ShipFlow"
echo "  tunnel     Gérer un tunnel ShipFlow"
echo "  re         Recharger le shell"
echo ""
if [ "$FONT_INSTALLED" = true ] && [ -s "$HOME/.termux/font.ttf" ]; then
    echo "Icônes"
    echo "  La Nerd Font est installée dans ~/.termux/font.ttf."
    echo "  Fermez complètement Termux puis rouvrez-le pour l'activer."
else
    echo "Icônes"
    echo "  La Nerd Font n'a pas été installée automatiquement."
    echo "  Consultez le log ou utilisez Termux:Styling depuis F-Droid."
fi
echo ""
echo "Non installé volontairement"
echo "  • Node.js et stack web"
echo "  • MCP"
echo "  • Agents IA"
echo "  • Copilot, Claude, Codex, OpenCode, Aider"
echo "  • Mason, LSP lourds, Treesitter auto-installé"
echo ""
echo "Détails techniques"
echo "  Log: $LOG_FILE"
echo "  Debug: TERMUX_DOTFILES_VERBOSE=1 bash ~/dotfiles/termux.sh"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
